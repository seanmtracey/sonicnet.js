...
SonicSocket.prototype.scheduleToneAt = function(freq, startTime, duration) {
  ...
  gainNode.gain.linearRampToValueAtTime(this.maxGain, startTime + this.rampDuration);
  gainNode.gain.setValueAtTime(this.maxGain, startTime + duration - this.rampDuration);
